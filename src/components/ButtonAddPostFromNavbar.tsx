      ...
      <DialogContent className="bg-black h-64 flex flex-col justify-center">
        <DialogHeader>
          ...
          <div className="relative">
            <div className="border-y-[#252525] py-2 relative">
              <form action={handleChange} className="flex flex-col items-end ">
                <textarea
                  ref={textAreaRef}
                  onInput={handleTextArea}
                  className="w-full duration-300 resize-none overflow-hidden outline-none border-y-2 border-y-[#252525] py-3 font-semibold text-lg bg-transparent text-white"
                  required
